...
# вважає загальну суму замовлення та повертає результат
...
# вважає загальну кількість замовленої одиниці товару та повертає результат
...
def get_total_coas(BD):
     ...
     # отримуємо список вартість за всіма позиціями замовлення у вигляді звичайного списку
     all_price = [BD.select_single_product_price(itm) for itm in all_product_id]
     # отримуємо список кількості за всіма позиціями замовлення у вигляді звичайного списку
